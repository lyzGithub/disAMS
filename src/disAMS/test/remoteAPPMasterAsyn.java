 ...
 */
public class remoteAPPMasterAsyn implements AMRMClientAsync.CallbackHandler {
    Configuration configuration;
    NMClient nmClient;
    String command;
    int numContainersToWaitFor;

    public remoteAPPMasterAsyn(String command, int numContainersToWaitFor) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        remoteAPPMasterAsyn master = new remoteAPPMasterAsyn(command, n);
        master.runMainLoop();
